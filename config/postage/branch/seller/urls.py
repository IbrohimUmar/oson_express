...
#     # products
    ...
    path('input/<int:logistic_branch_id>/<int:seller_id>', postage_branch_seller_input, name="postage_branch_seller_input"),
    path('input/api/<int:logistic_branch_id>/<int:seller_id>', postage_branch_seller_input_api, name="postage_branch_seller_input_api"),
