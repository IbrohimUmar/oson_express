...
@permission_required('admin.seller_app_payment_list', login_url="/home")
def seller_app_payment_list(request):
    ...
    return render(request, 'seller_app/payment/list.html', {'statuses':UserBalanceManager.status_choices,'page_obj': payments_obj, 'count': payments.count(),
                                                          })
