...
@permission_required('admin.seller_app_orders_list_delayed_delivery', login_url="/home")
def seller_app_orders_list_delayed_delivery(request):
    ...
    return render(request, "seller_app/orders/list/delayed_delivery.html",
