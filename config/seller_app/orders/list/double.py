...
@permission_required('admin.seller_app_orders_list_double', login_url="/home")
def seller_app_orders_list_double(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('seller_app_orders_list_double')
    return render(request, "seller_app/orders/list/double.html", {'data': data, 'queryset': queryset})
