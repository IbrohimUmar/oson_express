...
@permission_required('admin.seller_list', login_url="/home")
def seller_list(request):
    seller = User.objects.filter(type=4).order_by("-id")
    ...
    return render(request, 'seller/list.html', {'page_obj': queryset,'count': seller.count(),
