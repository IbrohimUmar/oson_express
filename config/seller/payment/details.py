...
@permission_required('admin.seller_payment_details', login_url="/home")
def seller_payment_details(request, payment_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('seller_payment_details',payment_id)


    print(cashier_list, cash)
    return render(request, 'seller/payment/details.html', {'payment': payment, 'cashier_list':cashier_list, 'cash':cash})
