...
@permission_required('admin.marketer_app_payment_create', login_url="/home")
def marketer_app_payment_create(request):
    ...
    if request.method == 'POST':
        try:
            ...
            return redirect("marketer_app_payment_create")

        user_balance = int(request.user.marketer_data.balance)
        ...
        return redirect("marketer_app_payment_list")

    return render(request, 'marketer_app/payment/create.html', {'minimal_pay':minimal_pay})
