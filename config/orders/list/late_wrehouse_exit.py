...
@permission_required('admin.orders_list_late_warehouse_exit', login_url="/home")
def orders_list_late_warehouse_exit(request):
    ...
    return render(request, "orders/list/late_warehouse_exit.html",
