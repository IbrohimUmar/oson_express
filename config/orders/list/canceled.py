...
@permission_required('admin.order_list_canceled', login_url="/home")
def orders_list_canceled(request):
    list_order = Order.objects.filter(status=5)
    ...
    return render(request, "orders/list/canceled.html",
