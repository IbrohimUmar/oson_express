...
@permission_required('admin.orders_list_all', login_url="/home")
def orders_list_all(request):
        ...
        try:
            with transaction.atomic():
                ...
                if order:
                    ...
                    return redirect("orders_list_all")
    ...
    return render(request, 'orders/list/all.html', {'quary': filter_query,'page_obj': order, "order": order, 'count': orders.count(),
